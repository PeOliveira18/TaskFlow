  ...
  return (
    <TouchableOpacity onPress={onPress} style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
      ...
      <View style={styles.footer}>
        ...
        <Text style={[styles.date, { color: colors.subtext }]}>{formatDate(task.updatedAt)}</Text>
      </View>
    </TouchableOpacity>
  );
}
...
const styles = StyleSheet.create({
  card: { borderRadius: 12, padding: 14, marginHorizontal: 16, marginVertical: 6, borderWidth: 1 },
