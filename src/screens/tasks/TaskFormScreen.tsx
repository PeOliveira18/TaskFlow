...
export function TaskFormScreen() {
  ...
  const [categoryIcon, setCategoryIcon] = useState(
    editing?.categoryIcon ?? CATEGORIES[0].icon,
  );
      ...
      <View style={styles.chips}>
        {STATUSES.map((s) => (
          ...
          >
            <Text
              style={{
                color: status === s ? "#fff" : colors.primary,
                fontSize: 13,
                fontWeight: "600",
              }}
            >
          ...
          <TouchableOpacity
            ...
            style={[
              styles.chip,
              {
                borderColor: colors.primary,
                backgroundColor:
                  priority === p ? colors.primary : "transparent",
              },
            ]}
          >
            <Text
              style={{
                color: priority === p ? "#fff" : colors.primary,
                fontSize: 13,
                fontWeight: "600",
              }}
            >
          ...
          <TouchableOpacity
            ...
            style={[
              styles.catBtn,
              {
                borderColor: colors.primary,
                backgroundColor:
                  category === cat.name ? colors.primary : colors.card,
              },
            ]}
          >
