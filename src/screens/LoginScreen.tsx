...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 32, fontWeight: '900', textAlign: 'center', marginBottom: 4 },
  subtitle: { textAlign: 'center', fontSize: 15, marginBottom: 32 },
  card: { borderRadius: 16, padding: 20, elevation: 2, shadowOpacity: 0.08, shadowRadius: 8, shadowOffset: { width: 0, height: 2 } },
