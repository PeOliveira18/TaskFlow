          ...
          <View style={styles.treatments}>
            {TREATMENTS.map((t) => (
              <TouchableOpacity
                ...
                style={[
                  styles.treatmentBtn,
                  { borderColor: colors.primary, backgroundColor: treatment === t ? colors.primary : 'transparent' },
                ]}
              >
                <Text style={{ color: treatment === t ? '#fff' : colors.primary, fontWeight: '600' }}>{t}</Text>
              </TouchableOpacity>
            ))}
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  treatmentBtn: { borderRadius: 20, borderWidth: 1.5, paddingHorizontal: 14, paddingVertical: 7 },
});
